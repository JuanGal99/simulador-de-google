document
  .querySelector(".form__microphone-icon")
  .addEventListener("click", voiceSearchModalOpen);
document
  .querySelector(".voice-search__close-modal")
  .addEventListener("click", voiceSearchModalClose);
document
  .querySelector(".voice-search__microphone-border")
  .addEventListener("click", voiceRecognition);
...
const voiceRecognition = () => {
  ...
  document.querySelector(".voice-search__result-text").innerHTML =
    "Habla ahora";
